...
(function () {
    ...
    if (spacer) {
        ...
        langBar.className = 'lang-switcher';
        langBar.innerHTML = `
      <button class="lang-btn ${getLang() === 'es' ? 'lang-btn-active' : ''}"
              data-lang="es" onclick="setLang('es')">ES</button>
      <button class="lang-btn ${getLang() === 'en' ? 'lang-btn-active' : ''}"
              data-lang="en" onclick="setLang('en')">EN</button>
    `;
        spacer.insertAdjacentElement('afterend', langBar);
    }
})();
